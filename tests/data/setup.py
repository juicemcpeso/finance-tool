...
# with open('test_db_2.json', 'w') as write_file:
#     json.dump(db_2, write_file, indent=4)
# print(json.dump(db_1))
# for table_name in db_1:
#     print(f"('{table_name}', {set(list(db_1[table_name][0].keys()))}),")
# # list(setup.db_1[table_name][0].keys())
